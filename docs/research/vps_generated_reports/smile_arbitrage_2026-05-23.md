# Smile Arbitrage Scan — 2026-05-23 22:55 UTC

Scanned active/open events for active trade stations (`KNYC, KMDW, KMIA`). Flagged events have at least one bucket whose normalized-share residual exceeds `0.03` with snapshot age ≤ `30` min and non-zero depth on the actionable side.
